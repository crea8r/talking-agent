...
MELO_DIR = ROOT_DIR / "vendor" / "MeloTTS"
OPENVOICE_DIR = ROOT_DIR / "vendor" / "OpenVoice"
CHECKPOINTS_DIR = OPENVOICE_DIR / "checkpoints_v2"
DEFAULT_PROCESSED_DIR = ROOT_DIR / ".." / ".." / "output" / "voice-cast" / "production-test" / "processed"
LOCAL_CACHE_DIR = ROOT_DIR / "vendor" / "production-voice" / ".cache"
